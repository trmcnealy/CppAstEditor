...
namespace CppAst.CodeGen.CSharp
{
    public class CSharpMethod : CSharpElement, ICSharpAttributesProvider, ICSharpElementWithVisibility
    {
        ...
        public List<CSharpAttribute> Attributes { get; protected set; }
        ...
        public List<CSharpParameter> Parameters { get; protected set; }
        ...
        {
            CodeWriterMode mode = writer.Mode;
    ...
    public static class CSharpMethodExtensions
    {
        ...
        {
            CSharpDllImportAttribute? dllImport = csMethod.Attributes.OfType<CSharpDllImportAttribute>().FirstOrDefault();

            // Create a new method
            CSharpMethod clonedMethod = new CSharpMethod
            {
                Name = csMethod.Name,
            ...
            {
                CSharpParameter fromParam = csMethod.Parameters[i];
                CSharpParameter clonedParam = fromParam.Clone();
            ...
            CSharpContainerList<CSharpElement> members = ((ICSharpContainer)csMethod.Parent).Members;
