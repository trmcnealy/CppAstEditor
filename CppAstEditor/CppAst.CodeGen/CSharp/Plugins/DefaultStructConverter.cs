...
namespace CppAst.CodeGen.CSharp
{
    ...
    public class DefaultStructConverter : ICSharpConverterPlugin
    {
        ...
        public static CSharpElement ConvertClass(CSharpConverter converter, CppClass cppClass, CSharpElement context)
        {
            ...
            string csStructName = converter.GetCSharpName(cppClass, context);
            CSharpStruct csStruct = new CSharpStruct(csStructName)
            {
                CppElement = cppClass,
            };

            ICSharpContainer container = converter.GetCSharpContainer(cppClass, context);
            ...
            {
                CSharpType csBaseType = converter.GetCSharpType(cppClass.BaseTypes[0].Type, context);
            ...
            {
                CppType fieldType = cppField.Type;
