...
namespace CppAst.CodeGen.CSharp
{
    ...
    public class DefaultInterfaceConverter : ICSharpConverterPlugin
    {
        ...
        public static CSharpElement ConvertClass(CSharpConverter converter, CppClass cppClass, CSharpElement context)
        {
            ...
            string csInterfaceName = converter.GetCSharpName(cppClass, context);
            CSharpInterface csInterface = new CSharpInterface(csInterfaceName)
            {
                CppElement = cppClass,
            };
            ...
            {
                CSharpType csType = converter.GetCSharpType(cppClass.BaseTypes[0].Type, context);
