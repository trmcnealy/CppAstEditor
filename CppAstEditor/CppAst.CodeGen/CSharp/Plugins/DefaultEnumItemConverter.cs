...
namespace CppAst.CodeGen.CSharp
{
    public class DefaultEnumItemConverter : ICSharpConverterPlugin
    {
        ...
        public static CSharpElement ConvertEnumItem(CSharpConverter converter, CppEnumItem cppEnumItem, CSharpElement context)
        {
            ...
            string enumItemName = converter.GetCSharpName(cppEnumItem, context);
            CSharpEnumItem csEnumItem = new CSharpEnumItem(enumItemName)
            {
            ...
            {
                string integerValue = converter.ConvertExpression(cppEnumItem.ValueExpression);
            ...
            {
                CSharpField csEnumItemAsField = new CSharpField(enumItemName)
                {
