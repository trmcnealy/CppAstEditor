...
namespace CppAst.CodeGen.CSharp
{
    ...
    public class DefaultDllImportConverter : ICSharpConverterPlugin
    {
        ...
        public static void AddDefaultDllImport(CSharpConverter converter, CSharpElement element, CSharpElement context)
        {
            ...
            CppCallingConvention callingConvention = (method.CppElement as CppFunction)?.CallingConvention ?? CppCallingConvention.Default;
            CallingConvention csCallingConvention = callingConvention.GetCSharpCallingConvention();
            string name = converter.Options.DefaultDllImportNameAndArguments ?? "LibNativeName";
