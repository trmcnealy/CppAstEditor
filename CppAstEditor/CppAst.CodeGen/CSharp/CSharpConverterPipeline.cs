...
namespace CppAst.CodeGen.CSharp
{
    ...
    public sealed class CSharpConverterPipeline
    {
        public CSharpConverterPipeline(CSharpConverterOptions options)
        {
            ...
            ExportToFunctionPointerConverters = new List<ConvertFunctionDelegate>();
        ...
        public List<ConvertFunctionDelegate> ExportToFunctionPointerConverters { get; }
        ...
        public void RegisterPlugins(CSharpConverter converter)
        {
            ...
            ExportToFunctionPointerConverters.Clear();
            ...
            for (int index = Options.Plugins.Count - 1; index >= 0; index--)
            {
                ICSharpConverterPlugin plugin = Options.Plugins[index];
